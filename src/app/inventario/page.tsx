...
import { Warehouse, Eye, Package, ClipboardList } from 'lucide-react'
...
const CATEGORIAS: Record<string, string> = {
  ...
  'Lacteos_Fiambres': 'Lacteos y Fiambres',
  'Bebidas': 'Bebidas',
  'Salsas_Recetas': 'Salsas y Recetas',
}

type TabType = 'stock' | 'hojas'
        ...
        <div>
          ...
          <p className="text-gray-600">
            {activeTab === 'stock'
              ...
              : 'Hojas de control de stock para imprimir'}
          </p>
        </div>
      </div>
          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">
                Marca insumos con el tilde Inventario para que aparezcan aca
              </p>
            </div>
          ) : (
